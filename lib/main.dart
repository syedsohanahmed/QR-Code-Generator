...
import 'package:fluttermasterwindows/AppConstant.dart' as AppConstant;
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'QR Code Generator by sosax coder',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      home: MyHomePage(title: 'QR Code Generator by sosax coder'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String textToConvert = "sosaxcoder.com";
